    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-slate-600">อสังหาริมทรัพย์</p>
                    <p class="text-2xl font-semibold text-slate-900">{{ $stats['published_properties'] + $stats['pending_properties'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-slate-600">ลูกค้า</p>
                    <p class="text-2xl font-semibold text-slate-900">{{ $stats['total_leads'] }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <p class="text-sm font-medium text-slate-600">เอกสาร</p>
                    <p class="text-2xl font-semibold text-slate-900">{{ $stats['failed_scrapes'] }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div class="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold">{{ $stats['pending_properties'] }}</p>
            </div>
        ...
        <div class="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold">{{ $stats['published_properties'] }}</p>
            </div>
        ...
        <div class="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex items-center justify-between">
            <div>
                <p class="text-sm text-slate-500 mb-1">Scrap พลาด</p>
                <p class="text-2xl font-bold">{{ $stats['failed_scrapes'] }}</p>
            </div>
        ...
        <div class="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex items-center justify-between">
            <div>
                <p class="text-sm text-slate-500 mb-1">ยอดคลิก Affiliate</p>
